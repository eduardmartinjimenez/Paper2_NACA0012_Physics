...
h5_filename = f"filtered_slice_correlations_{aoa_str}_{xc_str}.h5"
...
print(f"  /velocity_rms_ratios            : Velocity RMS values and ratios")
print(f"  /reconstruction_errors          : Reconstruction errors for wall signals")
print(f"  /velocity_reconstruction_errors : Reconstruction errors for velocity probes")
