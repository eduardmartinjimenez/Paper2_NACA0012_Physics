...
CORR_FILE = (
    ...
    "Freq_correlations_3D/band_limited_3d_correlation_maps_AOA5_Re50000.h5"
)
...
TS_FILE = (
    ...
    "3D_time_series_AoA5_Re50000_all_snapshots_20260603_011744.h5"
)
...
VIZ_XLIM_OFFSET = [0.06, 0.06] # Symmetric x-window
VIZ_YLIM_OFFSET = [0.012, 0.04]  # Extended y-window to show airfoil surface
...
def main():
    ...
    for correlation_type in CORRELATION_TYPES:
        for band in BANDS:
            ...
            # Positive-only plotting convention, same as the current colormap.
            vmin_plot = VMIN
            vmax_plot = max(visible_max, VMIN + 1e-12)
