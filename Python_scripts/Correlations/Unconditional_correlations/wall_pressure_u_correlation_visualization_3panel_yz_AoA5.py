...
VIZ_YLIM_OFFSET = [0.005, 0.02]  # y-window (wall-normal direction)
...
# Save figure
output_path_png = os.path.join(OUTPUT_DIR, "wall_pressure_u_correlation_1x3panel_yz_AOA5.png")
output_path_eps = os.path.join(OUTPUT_DIR, "wall_pressure_u_correlation_1x3panel_yz_AOA5.eps")
