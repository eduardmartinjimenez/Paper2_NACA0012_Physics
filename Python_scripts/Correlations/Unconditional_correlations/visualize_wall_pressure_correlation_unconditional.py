"""
Unconditional Wall-Pressure Correlation Visualization Script

This script generates comprehensive visualizations of unconditional wall-pressure stress
...
RESULT_FILE = (
    ...
    "Wall_pressure_correlations/test_3/"
...
#     "wall_pressure_correlation_unconditional_xc_0.700.h5"
# )
...
# - RIGHT PANEL: Correlation field between wall-pressure and velocity at Δz = 0
# - Allows direct spatial comparison between fluctuation intensity and correlation
#
# PURPOSE:
# - Investigates whether strong pressure-velocity correlation occurs in regions of large velocity fluctuations
# - Reveals the spatial relationship between turbulence activity and wall-pressure/streamwise-velocity coupling
...
# ============================================================================
# WHAT WE'RE PLOTTING:
# - Multi-location comparison of u'_rms/U_infty and wall-pressure correlation at Δz=0
# - One row per chord location (x/c)
# - Left column: velocity RMS normalized by freestream
# - Right column: pressure-velocity correlation field
...
h5_files = [f for f in all_files if f.startswith('wall_pressure_correlation_unconditional_xc_') and f.endswith('.h5')]
...
fig.suptitle(
    r'Comparison of $u^\prime_{rms}/U_\infty$ and wall-pressure correlation at $\Delta z = 0$ across chord locations',
    fontsize=14
)
...
fig.suptitle('Spanwise wall-pressure correlation decay at different chord locations', fontsize=14)
...
# ============================================================================
print(f"\n" + "=" * 70)
print("UNCONDITIONAL WALL-PRESSURE CORRELATION ANALYSIS SUMMARY")
print("=" * 70)
