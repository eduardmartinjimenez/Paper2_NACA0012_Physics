...
# Save figure
output_path_png = os.path.join(OUTPUT_DIR, "wall_shear_u_correlation_1x3panel_AOA5.png")
output_path_eps = os.path.join(OUTPUT_DIR, "wall_shear_u_correlation_1x3panel_AOA5.eps")
