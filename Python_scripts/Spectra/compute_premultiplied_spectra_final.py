...
#           Euu_full = (dz / (2.0 * np.pi * nz)) * (np.abs(U_full) ** 2)
#           Euu_pos = 2.0 * Euu_full[pos_mask]
...
SAVE_NAME = "premultiplied_spectra_data_all_final_9.h5"
...
# MESH_SLICE_PATH = "/home/jofre/Members/Eduard/Paper2/Simulations/NACA_0012_AOA12_Re50000_1716x1662x128/Slices_data/slices_test/last_slice/"
...
# SLICES_PATH = "/home/jofre/Members/Eduard/Paper2/Simulations/NACA_0012_AOA12_Re50000_1716x1662x128/Slices_data/slices_test/"

# Average data path
AVG_SLICE_PATH = "/home/jofre/disc2/Members/Eduard/NACA_0012_AOA12_Re50000_1716x1662x128/Slice_data/slice_9/last_slice/"
AVG_SLICE_NAME = "slice_9_avg_26517600-COMP-DATA.h5"
# AVG_SLICE_PATH = "/home/jofre/Members/Eduard/Paper2/Simulations/NACA_0012_AOA12_Re50000_1716x1662x128/Slices_data/slices_test/last_slice/"
...
for i, slice_file in enumerate(slice_files):
    ...
    try:
        ...
        for j in range(ny):
            ...
            # angular-wavenumber spectral density normalization
            U_full = np.fft.fft(u_line)
            Euu_full = (dz / (2.0 * np.pi * nz)) * (np.abs(U_full) ** 2)
...
# Create contour plot with square aspect ratio
fig, ax = plt.subplots(figsize=(8, 8))

# Use logarithmic scale for wavelength (lambda_z^+ = 2*pi / k_z^+)
lambda_z_plus = (2.0 * np.pi) / kz_plus_pos
X, Y = np.meshgrid(lambda_z_plus, y_plus_all)
Z = premult_pos

# Use individual min/max for this plot
...
# Set reasonable axis limits and square aspect
