...
INPUT_FILE_PATH = "/home/jofre/disc2/Members/Eduard/NACA_0012_AOA5_Re50000_1716x1662x128/Steady_state/batch_35801606/last_snapshot/"
INPUT_FILE_BASENAME = "3d_ibm_stl_naca0012_1916_1988_128_aoa5_Re50000"

# Define ouput folder path
OUTPUT_FILE_PATH = "/home/jofre/Members/Eduard/Paper2/Simulations/NACA_0012_AOA5_Re50000_1716x1662x128/last_snapshot/"
...
if __name__ == "__main__":
    ...
    for inst in instants:
        ...
        output_file.create_dataset("avg_u_compressed", data=u_avg_compressed, dtype="float32")
        output_file.create_dataset("avg_v_compressed", data=v_avg_compressed, dtype="float32")
        output_file.create_dataset("avg_w_compressed", data=w_avg_compressed, dtype="float32")
        output_file.create_dataset("avg_p_compressed", data=p_avg_compressed, dtype="float32")
        output_file.close()
