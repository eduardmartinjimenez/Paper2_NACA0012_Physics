...
ax.loglog(freq_ref, slope_ref * 1e5, 'k--', linewidth=2, alpha=0.5, label=r'$-5/3$')

# Add text label for slope
mid_idx = len(freq_ref) // 2
ax.text(freq_ref[mid_idx], slope_ref[mid_idx] * 1e5 * 2, r'$-5/3$', fontsize=12,
...
plt.tight_layout()
plt.savefig('/home/jofre/Members/Eduard/Paper2/Figures/Euu_spectra_AoA5.png', dpi=300, bbox_inches='tight')
plt.savefig('/home/jofre/Members/Eduard/Paper2/Figures/Euu_spectra_AoA5.eps', dpi=300, bbox_inches='tight')
plt.show()
